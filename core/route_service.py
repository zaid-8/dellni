...
class DellniRouteService:
    ...
    def _enrich_bus_leg(self, leg: dict[str, Any]) -> None:
        ...
        # Frontend snaps these stored route control points to OSM roads for display.
        leg["bus_geometry_locked"] = False
        leg["bus_shape_display"] = "route_control_points_snapped_to_osm_roads"
