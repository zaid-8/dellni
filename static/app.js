...
const i18n = {
  ar: {
    ...
    rateTrip: 'قيّم الرحلة بعد ما تخلص', rateTripHint: 'رأيك بيساعد دلني يحسن الاقتراحات للمستخدمين الجايين.', sendRating: 'إرسال التقييم', generalArea: 'اختيار المنطقة العامة', areaTitle: 'مش فارق الشارع بالزبط؟',
  ...
  en: {
    ...
    rateTrip: 'Rate the trip when finished', rateTripHint: 'Your feedback helps Dellni improve future route suggestions.', sendRating: 'Send rating', generalArea: 'General area mode', areaTitle: 'No exact street needed?',
